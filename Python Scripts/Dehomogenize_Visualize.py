# 
#	Name:
#	Dehomogenize Visualize
#
#	Purpose:
#		Generate an RVE Model and apply a defined strain, to visualize the
#		Dehomogenization process
...
def main():
    ...
    # displacement
    disp=1.0e-6 #this is one millistrain
    ...
    for iarrang in range(1):
        ...
        py_send("*apply_type fixed_displacement")
        py_send("*apply_dof x *apply_dof_value x")
        py_send("*apply_dof_value x " + `dispx + shrink_x`)
        py_send("*add_apply_nodes")
        py_send("*select_sets x1_nodes")
        py_send("*add_apply_nodes ")
        py_send("all_selected")
        ...
        py_send("*apply_type fixed_displacement")
        py_send("*apply_dof y *apply_dof_value y")
        py_send("*apply_dof_value y " + `dispy + shrink_y`)
        py_send("*add_apply_nodes")
        py_send("*select_sets y1_nodes")
        py_send("*add_apply_nodes ")
        py_send("all_selected")
        ...
        py_send("*apply_type fixed_displacement")
        py_send("*apply_dof z *apply_dof_value z")
        py_send("*apply_dof_value z " + `dispz + shrink_z`)
        py_send("*add_apply_nodes")
        py_send("*select_sets z1_nodes")
        py_send("*add_apply_nodes ")
        py_send("all_selected")
        ...
        py_send("*loadcase_name genericStrain")
