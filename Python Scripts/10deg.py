...
def main():
	...
	material = 'T800' #change from T300 or T800 as required
	orientation = 'Y'
	
	#adding in the support and symmetry planes
	py_send("*set_surface_type quad")
	py_send("*add_points -10 0 -10 121 0 -10 -10 0 20 121 0 20")#large plane of symmetry
	...
	if plate == 'TRUE':
		...
		py_send("*add_surfaces 98.5 0 15 98.5 4.5 15 5 5")
	else:
		py_send("*add_surfaces 60.5 0 -5 60.5 2.5 -5 5 5")
		py_send("*add_surfaces 22.5 0 15 22.5 2.5 15 5 5")
		py_send("*add_surfaces 98.5 0 15 98.5 2.5 15 5 5")
	...
	py_send("*select_elements -10 122 -10 2.5 -10 10")
	...
	py_send("*orient_param x1 0.9848")
	py_send("*orient_param z1 0.1736")
	...
	py_send("*add_contact_body_surfaces 2 # | End of List")
	
	py_send("*new_cbody geometry")
	py_send("*edit_contact_body cbody4")
	py_send("*contact_body_name TopCyl")
	py_send("*add_contact_body_surfaces 3 # | End of Lis")
	
	py_send("*new_cbody geometry")
	py_send("*edit_contact_body cbody5")
	py_send("*contact_body_name TopCyl2")
	...
	py_send("*select_nodes -10 130 -0.1 0.01 -20 20")
